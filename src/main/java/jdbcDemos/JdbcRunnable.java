    ...
    @Override
        public void run() {
            try {
                ...
                int i =0;
                LoggerSmallUtil.printTimeAndThread(String.format("begin to start insert job for table:%s",tableName));
                ...
                while (true) {
                    ...
                    if (i%500==0){
                        ...
                        //3、清空batch
                        ps.clearParameters();
                        LoggerSmallUtil.printTimeAndThread(String.format("success to insert 500 datas into table:%s",tableName));
                    }
                    i++;
